...
workflow PIPELINE_INITIALISATION {
    ...
    def String workflow_command = "nextflow run /path/to/stylo/main.nf -profile <singularity/rosalind> --input samplesheet.csv --outdir <OUTDIR>"
...
def toolBibliographyText() {
    ...
    def reference_text = [
            ...
            "<li>Dorado. (2022). In GitHub repository. GitHub. <a href=\"https://github.com/nanoporetech/dorado\">nanoporetech/dorado</a></li>",
