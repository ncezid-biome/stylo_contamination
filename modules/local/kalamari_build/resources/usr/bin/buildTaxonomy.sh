...
outdir="share/kalamari-$KALAMARI_VER/taxonomy"
mkdir -pv $outdir
...
# Build files
delnodes="/opt/conda/envs/kalamari/src/taxonomy/build/delnodes.txt"
addnodes="/opt/conda/envs/kalamari/src/taxonomy/build/nodes.dmp"
addnames="/opt/conda/envs/kalamari/src/taxonomy/build/names.dmp"
...
wget -O $tempdir/taxonomy.tar.gz ftp://ftp.ncbi.nih.gov/pub/taxonomy/taxdump.tar.gz
