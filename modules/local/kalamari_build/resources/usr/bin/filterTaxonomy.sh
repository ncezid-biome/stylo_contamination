...
outdir="share/kalamari-$KALAMARI_VER/taxonomy/filtered"
srcdir="share/kalamari-$KALAMARI_VER/taxonomy"
mkdir -pv $outdir
...
# source leaf taxids
kalamari_tsv=$(\ls /opt/conda/envs/kalamari/src/{chromosomes,plasmids,chromosomes-incomplete}.tsv)
